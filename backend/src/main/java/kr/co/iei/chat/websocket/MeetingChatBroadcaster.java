...
public class MeetingChatBroadcaster {
  ...
  public void broadcast(Long meetingId, Object payload) {
    ...
    for (WebSocketSession session : sessionRegistry.getOpenSessions(meetingId)) {
  ...
  private String toJson(Object payload) {
    try {
      ...
      throw new IllegalArgumentException("채팅 메시지를 JSON으로 변환할 수 없습니다.", exception);
    }
  }
